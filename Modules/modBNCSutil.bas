...
Public Function BNLSGetProductID(ByVal strProductID As String) As Long
    Select Case UCase$(strProductID)
        Case "STAR", "RATS", "SSHR", "RHSS": BNLSGetProductID = &H1
        Case "SEXP", "PXES": BNLSGetProductID = &H2
        Case "W2BN", "NB2W": BNLSGetProductID = &H3
        Case "D2DV", "VD2D": BNLSGetProductID = &H4
        Case "D2XP", "PX2D": BNLSGetProductID = &H5
        Case "JSTR", "RTSJ": BNLSGetProductID = &H6
        Case "WAR3", "3RAW": BNLSGetProductID = &H7
        Case "W3XP", "PX3W": BNLSGetProductID = &H8
    End Select
End Function

Public Sub GetHashes(ByVal ProductID As String, ByRef Hashes() As String)
    Select Case UCase$(ProductID)
        Case "D2DV", "D2XP"
            Hashes(0) = "Game.exe"
            Hashes(1) = "Bnclient.dll"
            Hashes(2) = "D2client.dll"
        Case "WAR3", "W3XP"
            Hashes(0) = "War3.exe"
            Hashes(1) = "Storm.dll"
            Hashes(2) = "Game.dll"
